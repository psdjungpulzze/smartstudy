defmodule FunSheepWeb.Layouts do
  ...
  @doc "Returns an emoji icon for a notification type atom."
  def notification_icon(:streak_at_risk), do: "🔥"
  def notification_icon(:streak_milestone), do: "🏆"
  def notification_icon(:test_upcoming_3d), do: "📅"
  def notification_icon(:test_upcoming_1d), do: "⏰"
  def notification_icon(:readiness_drop), do: "📉"
  def notification_icon(:readiness_milestone), do: "⭐"
  def notification_icon(:skill_mastered), do: "✅"
  def notification_icon(:skill_weak_confirmed), do: "📚"
  def notification_icon(:invite_received), do: "👋"
  def notification_icon(:share_received), do: "🔗"
  def notification_icon(:friend_milestone), do: "👥"
  def notification_icon(:friend_joined), do: "🐑"
  def notification_icon(:inactivity), do: "💤"
  def notification_icon(:weekly_digest), do: "📊"
  def notification_icon(:class_digest), do: "📋"
  def notification_icon(:student_at_risk), do: "⚠️"
  def notification_icon(:daily_habit_nudge), do: "🎯"
  def notification_icon(_), do: "🔔"
