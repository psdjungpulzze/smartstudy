defmodule StudySmartWeb.AuthController do
  @moduledoc """
  ...
  defp callback_url(_conn) do
    StudySmartWeb.Endpoint.url() <> "/auth/callback"
  end

  defp interactor_url,
    do: Application.get_env(:study_smart, :interactor_url, "https://auth.interactor.com")

  defp client_id, do: Application.get_env(:study_smart, :interactor_client_id, "")
  defp client_secret, do: Application.get_env(:study_smart, :interactor_client_secret, "")
end
