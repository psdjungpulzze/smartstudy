defmodule StudySmartWeb.RegisterLive do
  ...
  defp register_user(params) do
    ...
    body = %{
      ...
      redirect_uri: StudySmartWeb.Endpoint.url() <> "/auth/verify-email"
    }
  ...
  defp org_name,
    do: Application.get_env(:study_smart, :interactor_org_name, "studysmart")
