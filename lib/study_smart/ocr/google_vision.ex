defmodule StudySmart.OCR.GoogleVision do
  @moduledoc """
  ...
  def detect_text(image_content, opts \\ []) do
    if Application.get_env(:study_smart, :ocr_mock, false) do
  ...
  defp call_vision_api(base64_content, feature_type, _opts) do
    api_key = Application.get_env(:study_smart, :google_vision_api_key)
