defmodule StudySmart.Interactor.Client do
  @moduledoc """
  ...
  - Token injection from `StudySmart.Interactor.Auth`
  ...
  defp base_url,
    do: Application.get_env(:study_smart, :interactor_core_url, "https://core.interactor.com")
