defmodule StudySmart.Assessments.TestSchedule do
  @moduledoc """
  ...
  schema "test_schedules" do
    ...
    belongs_to :format_template, StudySmart.Assessments.TestFormatTemplate

    has_many :readiness_scores, StudySmart.Assessments.ReadinessScore
    has_many :study_guides, StudySmart.Learning.StudyGuide
